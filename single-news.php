            ...
            <?php if (have_posts()) : ?>
                ...
                <div class="pagenation">
                    <ul class="pagenation-ul">
                        <li class="prev"><?php previous_post_link('%link', '<i class="fas fa-chevron-left"></i> 前のお知らせへ'); ?></li>
                        <li class="next"><?php next_post_link('%link', '次のお知らせへ <i class="fas fa-chevron-right"></i>'); ?></li>
                    </ul>
                </div>
